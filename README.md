...
**Requirements:** Unraid **6.12.0+** (plugin metadata). Tested primarily on **Unraid 7.x**. Reports from other versions are welcome.
...
Full usage notes, array/pool examples, threshold order, notifications, and BTRFS guidance:
...
- Issues welcome via GitHub Issues (and an Unraid forum support thread when published)
...
Releases use `YYYY.MM.DD`, with an optional letter for same-day updates (`2026.07.09`, `2026.07.09a`, ...).
